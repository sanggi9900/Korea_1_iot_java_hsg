...
// 예외 (Exception)
// : 프로그램 실행 중에 발생할 수 있는 예기치 못한 존재나 조건

// 예외 처리
// : 예외가 발생할 경우 프로그램이 중단되지 않고 대응하여 정상적인 흐름을 유지하는 프로그램밍 기법

// === 자바 예외 클래스 ===
// Throwable: 모든 예외와 오류의 최상위 클래스
// - 모든 예외 클래스는 해당 클래스를 상속받음
// >> 예외나 관련된 메시지, 처리 방법에 대한 예시 정보를 포함

// 1) Exception
// : 프로그램이 처리할 수 있는 예외들의 클래스
// : 예외 처리를 통해 개발자가 처리할 수 있는 문제들을 정의

// 1-1) Checked Exeception
// : 컴파일(작성하고 있는) 시점에 체크되는 예외
// >> 개발자가 반드시 처리!
...
//		}
		...
		// >> 다중 catch 블로긍로 사용 가능 (여러 예외 처리 가능)
		
//		int division = 10 / 0;  // runtime 예외  
//		Exception in thread "main" java.lang.ArithmeticException: / by zero
//		at java_study/chapter10.Exception01.main(Exception01.java:56)
		...
		try {
			...
			System.out.println("초과 오류 발생 + e.getMessage()" + e.getMessage());
		} finally {
