...
public class A_Variable {
	...
	public static void main(String[] args) {
		...
		// - 숫자로 시작 X
		// - 기호는 _(언던스코어)와 $(달러)만 가능
		// - lowerCamelCase를 사용
		// - 자바의 예약어, 키워드는 변수명으로 사용X
		// +) 전체 대문자 사용 X(상수와 구분을 위해)
		...
		System.out.println("문자 :" + chr1);
		System.out.println("논리형 : " + bool1);
		...
		System.out.println("상수 실수 : " + PI);
		System.out.println("상수 정수 : " + RESIDENT_NUMBER);
