...
// : main + 자동완성(ctrl + space)
	public static void main(String[] args) {
		// 자바 기본 입출력
		// 입력 : 콘솔창을 통해 개발자로부터 입력을 받는것
		// 출력 : 콘솔창으로 데이터를 출력하는것
		
		// 1. 출력
		// System.out.println(출력하고자하는 변수 또는 데이터값);
		//syso 단축키로 자동완성
		...
		// Scanner(스캐너임) 변수명 = new Scanner(System.in);
		Scanner sc = new Scanner(System.in);
		
		// 스캐너 사용 방법
//		sc.next(); // 입력을 내용을 문자열로 반환
...
//		sc.nextDouble(); // 실수 데이터
		...
		int height = sc.nextInt(); // 정수입력
		
// 		버퍼에 남아있는 개행 문자(Enter)를 처리
		sc.nextLine();
		
		System.out.print("이름을 입력하세요: ");
		String name = sc.nextLine(); // 모든값을 입력 받을수 있다
		
		// 스캐너 종료 방법
//		: 스캐넌 사용 후 메모리 최적화를 위해 스캐너를 종료
//		>> .close()
		sc.close();
