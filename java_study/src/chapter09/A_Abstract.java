...
abstract class Human {
	...
	// >> 자식 클래스에서 해당 메서드를 반드시 구현하도록 강제하는 역활!
	// >> abstract 키워드를 사용 + 구현부 {} 대신 세미클론 ;을 사용하여 선언울 마침
	abstract void work();
}

// The type Police must implement the inherited abstract method Human.work()
class Police extends Human {
	void work() {
		System.out.println("경찰은 치안유지 없뮤를 담당합니다");
	}
}
...
//		Animal animal = new Animal(); - Error
		...
		dog.eat(); // 동묵을 먹이를 먹습니다 >> 부모 클래스에서 정의된 기능
		dog.makeSound();
