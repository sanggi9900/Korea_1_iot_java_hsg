...
class Restaurant {
	...
	void placeOrder(String dish, int ququantity) {
		System.out.println(dish + ququantity);
	}
	void placeOrder(String dish, String specialRequests) {
		System.out.println(dish + specialRequests);
	}
	void placeOrder(String dish, int ququantity, String specialRequests) {
		System.out.println(dish + ququantity + specialRequests);
	}
